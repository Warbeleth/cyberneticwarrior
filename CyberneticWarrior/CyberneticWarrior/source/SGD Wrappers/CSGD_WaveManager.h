...
public:
	...
	//
	//	Purpose			:	Gets the volume for the wave file.
	//						Use a range of [0 - 100]
	////////////////////////////////////////////////////////////////////////////
	int GetVolume(int nID);
	...
	//	Input			:	nID		-	ID of the wave file.
	//
	//	Return			:	The current Pan of the sound 
	//
	...
	////////////////////////////////////////////////////////////////////////////
	//	Function		:	"GetFrequencyCapabilities"
	//
	//	Last Modified	:	5/19/2009
	//
	//	Input			:	nMin	-	the minimum frequency of the sound device
	//						nMax	-	the maxamum frequency of the sound device
	//
	//	Return			:	true, if successful.
	//
	//	Purpose			:	Gets the minimum and maximum frequency the comuter's 
	//						sound device can support. Each type of sound card can  
	//						have diferent frequency capabilities
	////////////////////////////////////////////////////////////////////////////
	bool GetFrequencyCapabilities(int *nMin, int *nMax);
	...
	//	Input			:	nID		-	ID of the wave file.
	//
	//	Return			:	The current frequency of the sound 
	//
	//	Purpose			:	Gets the frequency for a wave file.
	////////////////////////////////////////////////////////////////////////////
	int GetFrequency(int nID);
